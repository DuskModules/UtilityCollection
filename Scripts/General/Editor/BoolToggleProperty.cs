...
namespace DuskModules {
  ...
  public class BoolToggleProperty : PropertyDrawer {
    ...
    public override void OnGUI(Rect position, SerializedProperty property, GUIContent label) {
      ...
      ExtraEditorUtility.DrawSettingsToggleDropdown(ExtraEditorUtility.contentPosition, boolProp, GetBoolTrueName(), GetBoolFalseName());
